                    ...
                    <tbody>
                        {users.map((user) => (
                            <tr key={user._id}>
                                ...
                                <td style={{backgroundColor:"white"}} ><button style={{backgroundColor:"red",padding:"10px 20px",borderRadius:"5px",border:"none"}} onClick={()=>handleDelete(user._id)}>delete</button></td>
                            </tr>
                        ))}
                    </tbody>
                </table>
